(* games/Hybrid1.ec for theorem `Simple4WHS`, composition `Hybrid1` — generated by `domino easycrypt`. *)

require import AllCore Distr FMap Int IntDiv Types.
require Interfaces Prot_NoKey KX_NoKeys.

clone Prot_NoKey as Pkg_Prot.

clone KX_NoKeys as Pkg_KX.
