Supplementary Material for the EuroCrypt 2027 Submission
===
...
For example, if you want to verify the simple 4WHS proof you can run
```
cargo run -p domino prove --proof Simple4WHS --parallel 12
```
