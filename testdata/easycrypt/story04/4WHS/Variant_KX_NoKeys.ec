...
module KX_NoKeys (P_Prot : Interfaces.Prot_NoKey_i) = {
  ...
  proc d_NewSession(d_U : int, u : bool, d_V : int, kid : int) : int option = {
    ...
    if (!(d_LTK.[kid] = None<:bits_n>)) {
      ...
      if (d_LTK.[kid] = None<:bits_n>) {
        ...
        ltk <- unwrap_1;
        d_State.[ctr_] <- (d_U, u, d_V, ltk, None<:bool>, None<:bits_n>, None<:bits_n>, None<:bits_n>, None<:(int * int * bits_n * bits_n * bits_n)>, 0);
  ...
  proc d_Send1(ctr : int) : bits_n option = {
    ...
    if (!(d_State.[ctr] = None<:(int * bool * int * bits_n * bool option * bits_n option * bits_n option * bits_n option * (int * int * bits_n * bits_n * bits_n) option * int)>)) {
      if (d_State.[ctr] = None<:(int * bool * int * bits_n * bool option * bits_n option * bits_n option * bits_n option * (int * int * bits_n * bits_n * bits_n) option * int)>) {

      } else {
        unwrap_1 <- oget d_State.[ctr];
        ec_r1 <@ P_Prot.d_Run1(state);
        if (ec_r1 = None<:((int * bool * int * bits_n * bool option * bits_n option * bits_n option * bits_n option * (int * int * bits_n * bits_n * bits_n) option * int) * bits_n)>) {
  ...
  proc d_Send2(ctr : int, msg : bits_n) : (bits_n * bits_n) option = {
    ...
    if (!(d_State.[ctr] = None<:(int * bool * int * bits_n * bool option * bits_n option * bits_n option * bits_n option * (int * int * bits_n * bits_n * bits_n) option * int)>)) {
      if (d_State.[ctr] = None<:(int * bool * int * bits_n * bool option * bits_n option * bits_n option * bits_n option * (int * int * bits_n * bits_n * bits_n) option * int)>) {
        ...
        if (ec_r1 = None<:((int * bool * int * bits_n * bool option * bits_n option * bits_n option * bits_n option * (int * int * bits_n * bits_n * bits_n) option * int) * (bits_n * bits_n))>) {
  ...
  proc d_Send5(ctr : int, msg : bits_n) : bool option = {
    ...
    if (!(d_State.[ctr] = None<:(int * bool * int * bits_n * bool option * bits_n option * bits_n option * bits_n option * (int * int * bits_n * bits_n * bits_n) option * int)>)) {
      if (d_State.[ctr] = None<:(int * bool * int * bits_n * bool option * bits_n option * bits_n option * bits_n option * (int * int * bits_n * bits_n * bits_n) option * int)>) {
        ...
        if (ec_r1 = None<:((int * bool * int * bits_n * bool option * bits_n option * bits_n option * bits_n option * (int * int * bits_n * bits_n * bits_n) option * int) * bool)>) {
