(define-fun <relation-lemma-debug-H6_1-H7_0-Send2>
    ((H61-old <GameState_H6_<$<!n!><!b!><!true!><!zeron!>$>>)
     ...
     (ctr Int) (msg Bits_n))
  Bool
  (and (= (__sample-rand-H6_1-Bits_n 2 (<game-H6-<$<!n!><!b!><!true!><!zeron!>$>-rand-2> H61-old))
          (__sample-rand-H7_0-Bits_n 3 (<game-H7-<$<!n!><!b!><!false!><!zeron!>$>-rand-3> H70-old)))
       (= (__sample-rand-H6_1-Bits_n 1 (<game-H6-<$<!n!><!b!><!true!><!zeron!>$>-rand-1> H61-old))
          (__sample-rand-H7_0-Bits_n 2 (<game-H7-<$<!n!><!b!><!false!><!zeron!>$>-rand-2> H70-old)))))
...
(define-fun <relation-lemma-debug-H6_1-H7_0-Test>
    ((H61-old <GameState_H6_<$<!n!><!b!><!true!><!zeron!>$>>)
     ...
     (ctr Int))
  Bool
  (and (= (__sample-rand-H6_1-Bits_n 1 (<game-H6-<$<!n!><!b!><!true!><!zeron!>$>-rand-1> H61-old))
          (__sample-rand-H7_0-Bits_n 1 (<game-H7-<$<!n!><!b!><!false!><!zeron!>$>-rand-1> H70-old)))
       (= (__sample-rand-H6_1-Bits_n 3 (<game-H6-<$<!n!><!b!><!true!><!zeron!>$>-rand-3> H61-old))
          (__sample-rand-H7_0-Bits_n 4 (<game-H7-<$<!n!><!b!><!false!><!zeron!>$>-rand-4> H70-old)))))
    ...
    (let ((nonce-ctr-61 (<game-H6-<$<!n!><!b!><!true!><!zeron!>$>-rand-2> H61-old))
      ...
      (let ((ctr0 (<pkg-state-Game_noprfkey-<$<!b!><!n!><!zeron!>$>-ctr_> game-H61))
        ...
        (let ((state (select State0-old ctr))
              (none (as mk-none (Maybe (Tuple11 Int Bool Int Int (Maybe Bool) (Maybe Bits_n)
                                                (Maybe Bits_n) (Maybe Bits_n) (Maybe Bits_n)
                                                (Maybe (Tuple5 Int Int Bits_n Bits_n Bits_n)) Int)))))
          (and
           (=> (= retval0 (as mk-abort (ReturnValue (Tuple2 Bits_n Bits_n))))
              (=> (not (= state none))
                  (let  ((U    (el11-1  (maybe-get state)))
                    ...
                    (or (not (= u true))
                        ...
                        (let ((sampled-rand (__sample-rand-H6_1-Bits_n 2 nonce-ctr-61)))
      ...
      (let ((ctr0 (<pkg-state-Game_noprfkey-<$<!b!><!n!><!zeron!>$>-ctr_> game-H61))
        ...
        (let ((state (select State1-old ctr))
              (none (as mk-none (Maybe (Tuple11 Int Bool Int Int (Maybe Bool) (Maybe Bits_n)
                                                ...
                                                (Maybe (Tuple5 Int Int Bits_n Bits_n Bits_n)) Int)))))
          (and
           (=> (= retval1 (as mk-abort (ReturnValue (Tuple2 Bits_n Bits_n))))
              (=> (not (= state none))
                  (let  ((U    (el11-1  (maybe-get state)))
                         (u    (el11-2  (maybe-get state)))
                         (V    (el11-3  (maybe-get state)))
                    ...
                    (or (not (= u true))
                        (not (= mess 0))
                        (not (= acc (as mk-none (Maybe Bool))))
                        (let ((sampled-rand (__sample-rand-H7_0-Bits_n 3 nonce-ctr-70)))
