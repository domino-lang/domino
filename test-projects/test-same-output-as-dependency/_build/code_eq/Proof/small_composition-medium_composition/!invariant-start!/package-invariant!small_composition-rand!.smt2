            ...
            (let ((state-0.rand (<game-SmallComposition-<$<!n!>$>-pkgstate-rand> state-0))
                 ...
                 (let ((state-0.rand.ctr (<pkg-state-Rand-<$<!n!>$>-ctr> state-0.rand))
                      ...
                      (let ((ctr-0 (<pkg-state-Rand-<$<!n!>$>-ctr> (<game-SmallComposition-<$<!n!>$>-pkgstate-rand> state-0)))
                           ...
                           (= ctr-0
                              ctr-1)))))
(declare-const <<game-state-small_composition-initial>>
               <GameState_SmallComposition_<$<!n!>$>>)
(assert (= (<pkg-state-Rand-<$<!n!>$>-ctr> (<game-SmallComposition-<$<!n!>$>-pkgstate-rand> <<game-state-small_composition-initial>>))
           0))
(declare-const <<game-state-medium_composition-initial>>
               <GameState_MediumComposition_<$<!n!>$>>)
(assert (= (<pkg-state-Rand-<$<!n!>$>-ctr> (<game-MediumComposition-<$<!n!>$>-pkgstate-rand> <<game-state-medium_composition-initial>>))
           0))
(assert (= (<pkg-state-Fwd-<$<!n!>$>-ctr> (<game-MediumComposition-<$<!n!>$>-pkgstate-fwd> <<game-state-medium_composition-initial>>))
           0))
(assert (not (package-invariant!small_composition-rand! <<game-state-small_composition-initial>>)))
