(define-state-relation invariant
    ((left-game <GameState_Composition_CCA_PKE>)
    ...
    (and
        ...
        (= (is-mk-none left-game.CCA_PKE.pk)
           ...
           (is-mk-none right-game.Correct_KEM.pk)
           (is-mk-none right-game.Correct_KEM.sk)
           (is-mk-none right-game.Reduction_Correct_KEM.pk))
        (= (is-mk-none left-game.CCA_PKE.c)
           (is-mk-none right-game.Correct_KEM.c)
           (is-mk-none right-game.Correct_KEM.k)
           (is-mk-none right-game.Reduction_Correct_KEM.c))
        (=> (is-mk-none left-game.CCA_PKE.pk)
            (is-mk-none left-game.CCA_PKE.c))
        (=>
            (not (is-mk-none left-game.CCA_PKE.c))
            (= (el2-1 (maybe-get left-game.CCA_PKE.c))
               (maybe-get right-game.Correct_KEM.c)))))
