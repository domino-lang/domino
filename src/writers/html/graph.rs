...
use crate::{
    package::Composition, util::smtsolver::SmtSolverBackend,
    writers::util::gamegraph::solve_composition_graph,
};
...
pub fn composition_graph(
    ...
    let solution = solve_composition_graph(backend, instance);
    solution.map(|model| {
