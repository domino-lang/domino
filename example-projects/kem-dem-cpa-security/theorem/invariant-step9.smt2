...
(define-state-relation relation-randomness
    ...
    (and 
        (rand-is-eq 
            ...
            (sample-id "pkg_DemScheme" "DEM_ENC" "dem_enc")
            (get-rand-ctr-pke_cpa_1 (sample-id "pkg_DemScheme" "DEM_ENC" "dem_enc"))
            (get-rand-ctr-hybrid2_0 (sample-id "pkg_DemScheme" "DEM_ENC" "dem_enc"))
        )
        (rand-is-eq 
            (sample-id "pkg_KemScheme" "KEM_ENCAPS" "kem_encaps")
            (sample-id "pkg_KemScheme" "KEM_ENCAPS" "kem_encaps")
            (get-rand-ctr-pke_cpa_1 (sample-id "pkg_KemScheme" "KEM_ENCAPS" "kem_encaps"))
            (get-rand-ctr-hybrid2_0 (sample-id "pkg_KemScheme" "KEM_ENCAPS" "kem_encaps"))
        )
    )
)
