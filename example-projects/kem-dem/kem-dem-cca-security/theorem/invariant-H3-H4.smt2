(define-state-relation invariant
    ...
    (and
        ...
        (= left-game.CCA_KEM.pk
           left-game.Reduction_KEM.pk
           right-game.Reduction_DEM.pk)
        ...
        (= (is-mk-none left-game.CCA_KEM.pk)
           ...
           (is-mk-none left-game.Reduction_KEM.pk)
           (is-mk-none right-game.Reduction_DEM.pk)
           (is-mk-none right-game.Reduction_DEM.sk))
        (= (is-mk-none left-game.CCA_KEM.c)
           (is-mk-none left-game.Reduction_KEM.c)
           (is-mk-none left-game.Reduction_KEM.k)
