...
(define-fun <relation-debug-H7_1_1_0-H7_1_1_1-Reveal>
    ((H710-old <GameState_H7_<$<!n!>$>>)
     ...
     (ctr Int))
  Bool
  (let ((state-H710 (<oracle-return-H7-<$<!n!>$>-KX_noprfkey-<$<!n!>$>-Reveal-game-state> H710-return))
        (state-H711 (<oracle-return-H7-<$<!n!>$>-KX_noprfkey-<$<!n!>$>-Reveal-game-state> H711-return))
        (retval0 (<oracle-return-H7-<$<!n!>$>-KX_noprfkey-<$<!n!>$>-Reveal-return-value-or-abort> H710-return))
        (retval1 (<oracle-return-H7-<$<!n!>$>-KX_noprfkey-<$<!n!>$>-Reveal-return-value-or-abort> H711-return)))
