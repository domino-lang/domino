...
(define-fun <relation-debug-H7_1_1_0-H7_1_1_1-NewKey>
    ((H710-old <GameState_H7_<$<!n!>$>>)
     (H711-old <GameState_H7_<$<!n!>$>>)
    ...
    (let ((nonces-H710 (<game-H7-<$<!n!>$>-pkgstate-Nonces> state-H710))
      ...
      (let ((ctr0 (<pkg-state-KX_noprfkey-<$<!n!>$>-ctr_> game-H710))
        ...
        (and (forall
              ...
              (=> (> kid kid0-old)
                  (let ((handle (mk-tuple2 (mk-tuple5 kid U V ni nr) (mk-tuple2 msg tag))))
                    (and (is-mk-none (select Values0-old handle)))))))))))
                         ;(is-mk-none (select ReverseMac0-old handle))
