...
The `with invariants [...]` scoping syntax is not supported. Use named state
relations as lemmata and explicit dependencies to control which established
facts are available to later claims.
