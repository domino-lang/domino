...
(define-fun invariant
    ...
    (let
        (
            ...
            (right_kem_c (<pkg-state-KEM-c> (<game-ModularPkeCcaGame-pkgstate-pkg_KEM> state-right)))
        ...
        (and
            ...
            (= ((_ is mk-none) left_c) ((_ is mk-none) right_c) ((_ is mk-none) right_kem_c) ((_ is mk-none) right_mod_cca_c_kem) ((_ is mk-none) right_dem_c) ((_ is mk-none) right_key_k)) ; left_challenge_ciphertext = None iff right_challenge_ciphertext = None iff right_encapsulation_challenge = None iff right_dem_challenge = None iff right_key_k = None
            (= left_sk right_sk) ; left_sk = right_sk
            (= right_mod_cca_c_kem right_kem_c) ; right encapsulated keys
            ...
            (=>
                ...
                (and
                    ...
                    (= (maybe-get right_kem_c) (el2-2 (<<func-kem_encaps>> (maybe-get right_encaps_randomness) (maybe-get right_pk_kem))))
                )
            )
            (forall 
                (
